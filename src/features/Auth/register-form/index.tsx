...
// Add these fields to IRegister (interface/register.interface.ts):
// addressLine1: string;
// addressLine2?: string;
// suburb: string;
// state: string;
...
// Free-text Australian address autocomplete using OpenStreetMap's Nominatim API.
// No API key required. For production, swap this for Australia Post's PAC API,
// Google Places Autocomplete, or Geoscape/Addressfinder for more accurate AU results.
